    ...
    while(i<5){
        ...
        while(j<8){
            ...
            if((i!=-1 || j<2) && (i!=0 || j<5) && (i!=0 || j!=7) && (i!=0 || j!=6) && (i!=2 || j<7) && (i!=3 || j<7) && (i!=1 || j<7) && (i!=2 || j!=0)){
                ...
                if((number4 >= 0 && number4 <= 10)) CGContextSetRGBStrokeColor(context, 180/255.0, 150/255.0, 29/255.0, 1.0);
                else if((number4 >= 11 && number4 <= 21)) CGContextSetRGBStrokeColor(context, 75/255.0, 0.0, 130/255.0, 1.0);
                else if((number4 >= 22 && number4 <= 27)) CGContextSetRGBStrokeColor(context, 255/255.0, 69/255.0, 0/255.0, 1.0);
