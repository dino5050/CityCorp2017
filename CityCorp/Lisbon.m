...
-(void)drawRect:(CGRect)rect {
    ...
    preferences8 = [NSUserDefaults standardUserDefaults];
    @try{faction5 = [disricts httprequest:@"city,server" :[NSString stringWithFormat:@"%@,%ld",@"Lisbon",[preferences8 integerForKey:@"server"]] :@"techfaction.php"];
        ...
        while(j<8){
            ...
            if((i!=0 || j!=0) && (i!=0 || j!=7) && (i!=0 || j!=5) && (i!=3 || j!=6) && (i!=0 || j!=6) && (i!=4 || j!=0)){
                ...
                //    CGContextFillPath(context);
                 ...
                 else if([districts15[number5] isEqualToString:@"globalists"]){CGContextSetRGBStrokeColor(context, 0.0, 100/255.0, 0.0, 1.0);}//east globalists
                 else {CGContextSetRGBStrokeColor(context, 100/255.0, 100/255.0, 100/255.0, 1.0);}                 /*               if((number5 >= 8 && number5 <= 11) || (number5 >= 23 && number5 <= 30) || (number5 >= 38 && number5 <= 40))
                ...
                */
                ...
                CGContextClosePath(context);
                 ...
                 else if([districts15[number5] isEqualToString:@"globalists"]){CGContextSetRGBFillColor(context, 0.0, 100/255.0, 0.0, 0.4);}//east globalists
                 else {CGContextSetRGBFillColor(context, 100/255.0, 100/255.0, 100/255.0, 0.4);}                 /*              if((number5 >= 8 && number5 <= 11) || (number5 >= 23 && number5 <= 30) || (number5 >= 38 && number5 <= 40)){ CGContextSetRGBFillColor(context, 255/255.0, 215/255.0, 0/255.0, 0.4);
                     corporation5 = @"CityCorp+West";
                     faction5 = @"capitalists";
                 }
...
-(void)district: (id)sender{
    ...
    if((int)clicked.tag>61){
        NSNumber* level;
        if((int)clicked.tag == 66 || ((int)clicked.tag>= 62 && (int)clicked.tag<=64) || ((int)clicked.tag>= 68 && (int)clicked.tag<=69) || (int)clicked.tag== 72 || (int)clicked.tag== 73 || (int)clicked.tag== 79 || (int)clicked.tag== 86 || (int)clicked.tag== 87) {level = [NSNumber numberWithInt:10];}
        ...
        NSString *district = [NSString stringWithFormat:@"LisID_%d", (int)clicked.tag];
